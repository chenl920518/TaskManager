...
public class QualityAnalysisTableController {
	...
	public String detailsPage(HttpServletRequest request,HttpServletResponse response) throws ParseException{
		...
		String projectRequirements=HttpClient.sendPost("http://112.64.174.34:33169/ERP-NBEmail/helpServlet?action=getContent&className=ExternalinterfaceServlet",param);
